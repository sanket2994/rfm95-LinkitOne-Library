...
#define RH_RF95_NUM_INTERRUPTS 2
...
class RH_RF95 : public RHspi
{
	public :
		...
		virtual bool recv(uint8_t *buff,uint8_t *len);
		...
		void setTxPower(int8_t power, bool useRF0=false);
