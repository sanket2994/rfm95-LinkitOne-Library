...
RH_RF95* RH_RF95::_deviceForInterrupt[RH_RF95_NUM_INTERRUPTS]={0,0};
...
RH_RF95::RH_RF95(uint8_t slaveSelectPin, uint8_t interruptPin)//doubtfull about this
:RHspi(slaveSelectPin)
{
...
bool RH_RF95::init()
{
    ...
    // Check we are in sleep mode, with LORA set
         ...
         if(_interruptCount<=RH_RF95_NUM_INTERRUPTS)
          {
            ...
            return false; //excedded interrupt count
       }
       ...
       if (_myInterruptIndex == 0)
        ...
        //setting fifo to initial position;
